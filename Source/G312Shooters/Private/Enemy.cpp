...
#include "G312Shooters/Public/Enemy.h"
...
AEnemy::AEnemy()
{
	...
	/*Replaced by PawnSensing*/
	AgroSphere = CreateDefaultSubobject<USphereComponent>(TEXT("AgroSphere"));
	AgroSphere->SetupAttachment(GetRootComponent());
	AgroSphere->InitSphereRadius(1600.f);
...
//
void AEnemy::BypassSetEMS(EEnemyMovementStatus Status)
{
}
...
void AEnemy::MoveToTarget(AG312ShootersCharacter* Target)
{
}
